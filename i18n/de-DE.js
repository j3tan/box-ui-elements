export default {
  ...
  "be.tasks.addTaskForm.selectAssigneesLabel": "Beauftragte(n) auswählen",
  ...
  "be.tasks.status.accepted": "Angenommen",
  "be.tasks.status.completed": "Abgeschlossen",
  "be.tasks.status.inProgress": "Ausstehend",
  "be.tasks.status.notStarted": "Ausstehend",
  "be.tasks.status.rejected": "Abgelehnt",
