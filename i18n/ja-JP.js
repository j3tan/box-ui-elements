export default {
  ...
  "be.sidebarVersions.deletedBy": "{name}が削除",
  ...
  "be.tasks.addTask.approval": "承認",
  "be.tasks.addTask.approval.description": "作業を進めるための承認を要求します",
  "be.tasks.addTask.general": "タスク",
  ...
  "be.tasks.status.accepted": "承諾済み",
  "be.tasks.status.completed": "完了",
  "be.tasks.status.inProgress": "待機中",
  "be.tasks.status.notStarted": "待機中",
  "be.tasks.status.rejected": "拒否",
