export default {
  ...
  "be.tasks.addTaskForm.selectAssigneesLabel": "Vælg modtager(e)",
  ...
  "be.tasks.status.accepted": "Accepteret",
  "be.tasks.status.completed": "Fuldført",
  "be.tasks.status.inProgress": "Afventer",
  "be.tasks.status.notStarted": "Afventer",
  "be.tasks.status.rejected": "Afvist",
